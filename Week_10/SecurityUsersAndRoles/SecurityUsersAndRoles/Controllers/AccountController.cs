...
namespace SecurityUsersAndRoles.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [Authorize(Roles="Administrator")]
        public ActionResult RegisterFacultyUser()
        {
            return View();
        }
        ...
        public async Task<ActionResult> RegisterFacultyUser(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                // Notice the new properties
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Add the new user to the "Student" role
